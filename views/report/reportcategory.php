...
<section>
		...
		<div class="col-md-6 text-right pr-0">
            ...
            <div class="card-body">
			  ...
			  <div class="form-group row">
                  ...
                  <input type="text" class="form-control datepicker1" id="sdate" name="sdate" placeholder="End Date" value="<?= $sdate ; ?>">
                </div>
				</div>
				</div>
				</div>
			   ...
			   <div class="form-group row">
                    ...
                    <div class="form-group text-center pt-3">
                        <input type="submit" value="Search" class="btn btn-add btn-sm btn-search ml-0">
                    </div>
                    </div>
                    <div class="col">
	...
	?><?php } ?>
                ...
                <div class="statistics col-xl-4 col-sm-6">
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    ...
                    <div class="text"><small style="color:black;font-size:18px;">Categories Sold</small><strong >&nbsp;<?= count($categoryValue)??0 ?></strong>
                    <div class="progress" style="height:10px">
                            <div class="progress-bar bg-info progress-bar-striped progress-bar-animated" style="width:60%;height:20px"></div>
                    </div>
                    </div>
  ...
  <table id="example" class="table table-striped table-bordered table2excel" >
	...
	<tr align="center">
            ...
            <th>Unit Price</th>
            <!-- <th>Discount</th> -->
            <th>Total Worth (Without Discount & Coupons)</th>
	</tr>
	</thead>
	<tbody>
	<?php 
  ...
  $qtyprice = [];
    ...
    <td align="center"><?= $qtyprice[]=$category['orytotal_sale_qty']*$category['totalamount']; ?></td>
    ...
    <td></td>
		<td align="center" style="font-size:20px;color:black;"><strong><?= array_sum($qtyprice)??0 ?></strong></td>
	</tr>
	</tbody>
	</table>
	</div>
