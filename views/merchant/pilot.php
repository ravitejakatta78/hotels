		    ...
		    <tbody>
								...
								?>
                                 ...
                                 <td>
													...
													</button> (<?php echo !empty($pilotBuzzArray[$pilotModel['ID']]) ? $pilotBuzzArray[$pilotModel['ID']] : 0; ?>)</td> 
										</tr>			
                                                	<?php $x++; }?>
                       </tbody>
                  </table>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
    		...
    		'id' => 'pilot-form',
        'action' => 'employeelist',
		'options' => ['class' => 'form-horizontal','wrapper' => 'col-xs-12','onsubmit' => 'return validateSection()'],
        	'layout' => 'horizontal',
			 'fieldConfig' => [
...
<div class="col-md-6">
	   ...
	   <div class="col-md-8">
		<select name="sectiongroup[]" class="test" id="sectiongroup" multiple="multiple"> 
					<option value="">Select Section Name</option>
					<?php  foreach($categorytypes as $ca){ ?>
					<option value="<?php echo $ca['ID']; ?>"><?php echo $ca['section_name']; ?></option>
					<?php } ?>
					</select>
					<span class="err-msg-section" style="color:red;display:none">Please Select Atleast One Section</span>			
	   ...
	   <div class="modal-footer">
		<?= Html::submitButton('Add Employee', ['class'=> 'btn btn-add btn-hide','id' => 'addempbtn']); ?>
...
{
	var roleName = $('#merchantemployee-emp_role  option:selected').text();;
	if(roleName == 'PILOT' && $("#sectiongroup").val() == "") {
