          ...
          <div class="col-lg-12">
			...
			<?php $x= 1; foreach($couponModel as $couponModel) { ?>
						<tr>	
											...
											<td><?=MyConst::_ORDER_SERVICE_TYPE[$couponModel['coupon_for']];?></td>
   ...
   <div class="col-md-4">
	   ...
	   <div class="col-md-8">
		    <?= $form->field($model, 'type')->dropdownlist(['amount'=>'Amount','percent'=>'Percentage']
				  ,['prompt'=>'Select Discount Type','onchange'=>'percentagecheck()'])->label(false); ?>
...
<div class="col-md-4">
	   ...
	   <div class="col-md-4">
	   <div class="form-group row">
	   <label class="control-label col-md-4">Coupon For</label>
	   <div class="col-md-8">
			      <?= $form->field($model, 'coupon_for')
				  ->dropdownlist([MyConst::_ORDER_SERVICE_TYPE])
				  ->label(false); ?>
	   </div></div>
	   </div>
...
<?php ActiveForm::end() ?>      
  ...
  <div id="editcoupon" class="modal fade" role="dialog"  data-backdrop="static" data-keyboard="false">
<div class="modal-dialog modal-xl" >
      <div class="modal-content">
...
function percentagecheck(){
	...
	if(merchantcoupon_type == 'amount')
	{
		$("#merchantcoupon-maxamt").val("");
		$("#merchantcoupon-maxamt").val($("#merchantcoupon-price").val());
		$("#merchantcoupon-maxamt").prop('readonly', true);
	}
	else{
		$("#merchantcoupon-maxamt").prop('readonly', false);
	}
