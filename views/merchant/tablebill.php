...
<header class="page-header">
		...
		<div class="col-xs-12 item-shdw p-2 mb-2">
		  ...
		  <img src="<?= Yii::getAlias('@basePath').'/merchant_images/productimages/'.Utility::product_details($orderProdDet[$i]['product_id'],'image');?>" class="rounded-circle" width="100px" height="100px">
		  </div>
		  <div class="col-md-6">
