...
<div class="col-md-6">	
	   ...
	   <div class="col-md-8">
			      <?= $form->field($model, 'title', ['enableAjaxValidation' => true])->textinput(['class' => 'form-control titleedit spaceClass','onkeydown'=>'autocompleteproduct()' ,'placeholder'=>'Item Name'])->label(false); ?>
	   </div>
	   </div>
	   <div class="form-group row">
	   <label class="control-label col-md-4">Item Code</label>
	   <div class="col-md-8">
			      <?= $form->field($model, 'unique_id', ['enableAjaxValidation' => true])->textinput(['class' => 'form-control titleedit spaceClass','onkeydown'=>'autocompleteproduct()' ,'placeholder'=>'Item Code'])->label(false); ?>
	   </div>
	   </div>
	   <div class="form-group row">
	   <label class="control-label col-md-4">Item Tag</label>
	   <div class="col-md-8">
			      <?= $form->field($model, 'labeltag')->textinput(['class' => 'form-control labeltagedit spaceClass','placeholder'=>'Item Tag'])->label(false); ?>
	   </div></div>
	   <div class="form-group row">
