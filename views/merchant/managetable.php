...
<td class="icons">
    ...
    <!-- <a class="label label-xs label-warning " <?php if(!empty($merchantdetails['qrlogo'])){?>
        href="../../../superpilotmultiqr.php?table=<?= $productlist['ID'];?>&tablename=<?= $productlist['name'];?>&userid=<?= $merchantdetails['ID']; ?>&qrlogo=<?= $merchantdetails['qrlogo']; ?>&qrtype=new" <?php }?> target="_blank" ><span class="fa fa-download"></span></a> -->
</td>
...
<div class="modal fade" id="myModal">
    ...
    <tbody>
                <tr>
            <td>
                <input type="text"  name="tablename[]" class="form-control spot spaceClass" autocomplete="off" required/>
            </td>
            
			<td>
                <input type="text" name="capacity[]" class="form-control spaceClass" autocomplete="off" required>
            </td>
...
function qrlatestpreview (tableid,tablename,userid,qrlogo,qrpath){


    var form=document.createElement('form');
    form.setAttribute('method','post');
    form.setAttribute('action','qrone');
    form.setAttribute('target','_blank');
