          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header d-flex align-items-center pt-0 pb-0">
                <h3 class="h4 col-md-6 pl-0 tab-title">Valet List</h3>
				<div class="col-md-6 text-right pr-0">
				<button type="button" class="btn btn-add btn-xs" id="myBtn" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus mr-1"></i> Add Valet</button>
					...
					<tbody>
						...
						?>
                            <tr>
								...
								<td>
									<label class="switch">
										<input type="checkbox" <?php if($empModel[ 'loginaccess']=='1' ){ echo 'checked';}?> 
										onChange="changeloginaccess('valet',
										<?php echo $empModel['ID'];?>);"> <span class="slider round"></span> </label> 
								</td>    
								<td>
									<label class="switch">
										<input type="checkbox" <?php if($empModel[ 'loginstatus']=='1' ){ echo 'checked';}?> 
										onChange="changeloginstatus('valet',
										<?php echo $empModel['ID'];?>);"> <span class="slider round"></span> </label>
								</td>
                                <td>
                                    <label class="switch">
                                    <input type="checkbox" <?php if($empModel['emp_status']=='1' ){ echo 'checked';}?> 
									onChange="changestatus('valet',
                                    <?php echo $empModel['ID'];?>);"> <span class="slider round"></span> </label>
                                </td>
								<td class="icons">
									<a onclick="updatevalet('<?= $empModel['ID'];?>')"><span class="fa fa-pencil"></span></a>
									<a onclick="deletevalet('<?= $empModel['ID'];?>')"><span class="fa fa-trash"></span></a>
								</td>
							</tr>			
                                                	<?php $x++; }?>
                    </tbody>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Add Valet</h4>
...
<div class="col-md-6">
	   ...
	   <div class="modal-footer">
		<?= Html::submitButton('Add Valet', ['class'=> 'btn btn-add btn-hide']); ?>
...
<?php ActiveForm::end() ?>
    ...
    <div id="updatevalet" class="modal fade" role="dialog">
<div class="modal-dialog modal-lg" >
      <div class="modal-content">
      
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Edit Valet</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
