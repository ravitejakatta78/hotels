...
?>
    <div class="modal-body">
		...
		<div class="col-md-8">
		 <?= $form->field($model, 'name',['enableAjaxValidation' => true])->textinput(['class' => 'form-control spaceClass','style'=> 'text-transform: uppercase','placeholder'=>'Spot Name'])->label(false); ?>
