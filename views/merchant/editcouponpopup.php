...
<div class="col-md-4">
	   ...
	   <div class="col-md-8">
			      <?= $form->field($model, 'maxamt')->textinput(['class' => 'form-control maxamt','placeholder'=>'Max Amount of Discount'])->label(false); ?>
	   </div></div>
	   </div>
...
<div class="col-md-4">
	   ...
	   <div class="col-md-8">
			      <?= $form->field($model, 'price')->textinput(['class' => 'form-control merchantcoupon-price discount-price','placeholder'=>'Amount Of Discount'])->label(false); ?>
	   </div></div>
	   </div>
...
$script = <<< JS
	...
	{
		$(".maxamt").val("");
		$(".maxamt").val($(".discount-price").val());
		$(".maxamt").prop('readonly', true);
	}
	else{
		$(".maxamt").prop('readonly', false);
	}
JS;
