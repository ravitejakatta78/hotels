		    ...
		    <tbody>
								...
								?>
                                  <tr>
                                 	...
                                 	<td><img src="<?php echo  Yii::getAlias('@basePath').'/merchant_images/productimages/'. $productlist['image'];?>" alt="" class="img-table dash-icon" style="height:50px"/></td> 
...
<div class="col-md-6">	
	   ...
	   <div class="col-md-8">
			      <?= $form->field($model, 'title', ['enableAjaxValidation' => true])->textinput(['class' => 'form-control title spaceClass','autocomplete'=>'off','placeholder'=>'Item Name'])->label(false); ?>
	   </div>
	   </div>
	   <div class="form-group row">
	   <label class="control-label col-md-4">Item Tag</label>
	   <div class="col-md-8">
			      <?= $form->field($model, 'labeltag')->textinput(['class' => 'form-control labeltag spaceClass','placeholder'=>'Item Tag'])->label(false); ?>
	   </div></div>
	   <div class="form-group row">
	   <label class="control-label col-md-4">Serve Line</label>
	   <div class="col-md-8">
			      <?= $form->field($model, 'serveline')->textinput(['class' => 'form-control spaceClass','placeholder'=>'Serve Line'])->label(false); ?>
	   </div></div>
	   <div class="form-group row">
...
<div class="col-md-6">
	   ...
	   <div class="col-md-8">
			      <?= $form->field($model, 'unique_id', ['enableAjaxValidation' => true])->textinput(['class' => 'form-control spaceClass'])->label(false); ?>
	   </div></div>
	   <div class="form-group row">
