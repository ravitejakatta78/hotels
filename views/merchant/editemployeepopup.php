...
?>
			...
			'options' => ['class' => 'form-horizontal','wrapper' => 'col-xs-12','onsubmit' => 'return validateUpdateSection()'],
        	'layout' => 'horizontal',
			 'fieldConfig' => [
...
<div class="col-md-6">	
	   ...
	   <div class="col-md-8">
				  ...
				  ->dropdownlist(\yii\helpers\ArrayHelper::map(\app\models\EmployeeRole::find()->all(), 'ID', 'role_name'),['prompt'=>'Select', 'class' => 'form-control update-merchant-role']) 
				  ->label(false); ?>
  ...
  <div class="form-group row">
	   ...
	   <div class="col-md-8">
		<select name="sectiongroup[]" class="select" id="groupmultiselect" multiple="multiple"> 
					...
					<span class="err-update-msg-section" style="color:red;display:none">Please Select Atleast One Section</span>			
...
{
	var roleName = $('.update-merchant-role  option:selected').text();
	if(roleName == 'PILOT' && $("#groupmultiselect").val() == "") {
		
		$(".err-update-msg-section").show();
		return false;
	} else {
		$(".err-update-msg-section").hide();
		return true;
	}
}
</script>    
