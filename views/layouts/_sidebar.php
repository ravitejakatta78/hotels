   ...
   <!--         </li>-->
    ...
    <!--        <li class="<?php if($actionId == 'newpos' || $actionId == 'placeorder' || $actionId == 'currentorders' || $actionId == 'orders'  || $actionId == 'parcels' || $actionId == 'viewkdsone') { echo "active" ;} ?>"><a href="<?= Url::to(['merchant/newpos']); ?>"><i class="fa fa-list-alt"></i>Orders </a>
		  ...
		  <?php if( ( $roleId == '0' || in_array('Ratings',$permissions)) && in_array('8',$tabPermissions) ) { ?>
            ...
            <li class="<?php if($actionId == 'merchant-ratings' || $actionId == 'pilot-ratings') { echo "active" ;} ?> ">
				<a href="<?php echo Url::to(['ratings/merchant-ratings']); ?>"> <i class="fa fa-star-o"></i>Ratings </a>
			</li>
					  <?php } ?>
...
<?php } ?>  
 ...
 <!--               <?php } ?>-->
				...
				<?php } ?>       
                                ...
                                <li class="<?php if($actionId == 'cancelled-orders') { echo "active" ;} ?>"><a href="<?= Url::to(['order/cancelled-orders']); ?>">Cancelled Orders</a></li>
                                <li class="<?php if($actionId == 'removed-products') { echo "active" ;} ?>"><a href="<?= Url::to(['order/removed-products']); ?>">Removed Items</a></li>
              </ul>
            </li>
					  <?php } ?>
...
<?php } ?>           
			 ...
			 <li class="<?php if($actionId == 'index') { echo "active" ;} ?>">
			    <a href="<?php echo Url::to(['counter-settlement/index']); ?>"> <i class="fa fa-cube"></i>Settlement </a>
			</li>

			<li class="<?php if($actionId == 'add-printers') { echo "active" ;} ?>">
			    <a href="<?php echo Url::to(['merchant/add-printers']); ?>"> <i class="fa fa-cube"></i>Printers</a>
			</li>
...
<?php } ?>           
			...
			<li class="<?php if($actionId == 'valetlist') { echo "active" ;} ?>"><a href="#valetDropdown" aria-expanded="false" data-toggle="collapse"><i class="fa fa-car"></i>Valet Parking</a>
				<ul id="valetDropdown" class="collapse list-unstyled collapse show">
					<li class=""><a href="#">Parking History</a></li>
					<li class="<?php if($actionId == 'valetlist') { echo "active" ;} ?>"><a href="<?= Url::to(['merchant/valetlist']); ?>">Manage Valet</a></li>
					<li class="<?php if($actionId == 'parkingtoken') { echo "active" ;} ?>"><a href="<?= Url::to(['merchant/parkingtoken']); ?>">Parking Tokens</a></li>
					<li class=""><a href="#">Valet Rating</a></li>
				</ul>
			</li>
            		  <?php } ?>
		 <!-- <?php if($roleId == '0' ) { ?>-->
