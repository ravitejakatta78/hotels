...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo Yii::getAlias('@abspath'); ?>/Frame49.png" type="image/x-icon" />
...
<?= Html::csrfMetaTags() ?>
    <?php $this->head() ?>
	<script src="<?= Yii::getAlias('@abspath').'/js/code.jquery-3.3.1.js'?>"></script>
...
?>
  ...
  $(document).on('change keyup', '.spaceClass', function(){
